...
public class CameraActivity extends AppCompatActivity implements CameraDialog.CameraDialogParent, CameraViewInterface.Callback {
    ...
    private void initView() {
        ...
        mSeekBrightness =(SeekBar) findViewById(R.id.seekbar_brightness);
        mSeekContrast = (SeekBar) findViewById(R.id.seekbar_contrast);
        mSwitchVoice = (Switch) findViewById(R.id.switch_rec_voice);
    ...
    private void showResolutionListDialog() {
        ...
        View rootView = LayoutInflater.from(CameraActivity.this).inflate(R.layout.layout_dialog_list, null);
        ListView listView = (ListView) rootView.findViewById(R.id.listview_dialog);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(CameraActivity.this, android.R.layout.simple_list_item_1, getResolutionList());
        if (adapter != null) {
